...
public class ScreeningService extends ParentService<Screening> {
    ...
    public Screening create(long movieId, LocalDateTime dateTime, long roomId, int rowsAmount, int seatsPerRow) throws EntityNotFoundException {
        ...
        Screening screening = new Screening(movie, dateTime, room, rowsAmount, seatsPerRow);
    ...
    public List<Row> getRows(long screeningId) throws EntityNotFoundException {
        return find(screeningId).getRows();
    }
